...
public class Fraction_Exponents_To_Radical_Exponent
{
   ...
   {  
      ...
      System.out.println("9.2 Fraction Exponents to Radical Exponents\n");
      ...
      if (isEven) 
     {
      ...
      int exponent = Exponent_Fraction_Numerator; 
      double finalAnswer = Math.pow(Answer, exponent); 
    ...
    while (!foundMatch);
    {
     ...
     if (foundMatch)
     {
      ...
      int exponent = Exponent_Fraction_Numerator;
      double finalAnswer = Math.pow(b, exponent); 
      System.out.printf("final answer is " + finalAnswer);  
      }
      else
      {
